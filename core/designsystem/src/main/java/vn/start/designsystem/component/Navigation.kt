...
fun RowScope.CustomNavigationBarItem(
    ...
    NavigationBarItem(
        ...
        colors = NavigationBarItemDefaults.colors(
            selectedIconColor = CustomNavigationDefaults.navigationSelectedItemColor(),
            unselectedIconColor = CustomNavigationDefaults.navigationContentColor(),
            selectedTextColor = CustomNavigationDefaults.navigationSelectedItemColor(),
            unselectedTextColor = CustomNavigationDefaults.navigationContentColor(),
            indicatorColor = CustomNavigationDefaults.navigationIndicatorColor(),
        ),
    )
}
...
fun CustomNavigationBar(
    ...
    NavigationBar(
        modifier = modifier,
        contentColor = CustomNavigationDefaults.navigationContentColor(),
        tonalElevation = 0.dp,
        content = content,
    )
}
...
/**
 * App navigation suite scaffold with item and content slots.
 * Wraps Material 3 [NavigationSuiteScaffold].
 *
 * @param modifier Modifier to be applied to the navigation suite scaffold.
 * @param navigationSuiteItems A slot to display multiple items via [CustomNavigationSuiteScope].
...
fun CustomNavigationSuiteScaffold(
    ...
    NavigationSuiteScaffold(
        ...
        navigationSuiteColors = NavigationSuiteDefaults.colors(
            navigationBarContentColor = CustomNavigationDefaults.navigationContentColor(),
 ...
 */
object CustomNavigationDefaults {
    @Composable
