    ...
    Box(modifier = modifier) {
        val containerColor = if (followed) {
            ...
            MaterialTheme.colorScheme.surfaceVariant.copy(
                alpha = CustomTagDefaults.UNFOLLOWED_TOPIC_TAG_CONTAINER_ALPHA,
            )
        }
        TextButton(
            onClick = onClick,
            ...
            colors = ButtonDefaults.textButtonColors(
                ...
                disabledContainerColor = MaterialTheme.colorScheme.onSurface.copy(
                    alpha = CustomTagDefaults.DISABLED_TOPIC_TAG_CONTAINER_ALPHA,
                ),
            ),
        ) {
...
fun TagPreview() {
    CustomAppTheme {
        CustomTopicTag(followed = true, onClick = {}) {
...
/**
 * App tag default values.
 */
object CustomTagDefaults {
